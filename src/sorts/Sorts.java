...
public class Sorts {
    ...
    public static class MergeSort implements SortingStrategy {
        public void sort(int[] arr) {
    ...
    public static class InsertionSort implements SortingStrategy {
        public void sort(int[] arr) {
            int n = arr.length;
            for (int i = 1; i < n; ++i) {
                int key = arr[i];
    ...
    public static class SelectionSort implements SortingStrategy {
        public void sort(int[] arr) {
            int n = arr.length;
